...
#print(a , b , c , separator = ':') # Error  :   print()  function  does  not  have  separator  argument
...
4) print(object , sep = ' , ')
    Is  sep  argument  needed  in  the  above  print()  function ?  ---> No  becoz  single  object  is  being  printed

5) When  is  sep  argument  needed  in  print()  function  ?  --->  When  more  than  one  object  is  being  printed

6) What  is  the  separator  between  hours , minutes  and  seconds ?  --->  ':'  i.e.  sep = ':'
    What  is  the  separator  between  date , month  and  year ?  --->  '-'  (or) '/'  (or)  '.'  (or)  ' '
'''
