...
1) What  does  sep  argument  do ? --->  Determines  the  delimeter  to  be  printed  'between'  the  results

2) What  does  end  argument  do ?  --->  Determines  the  delimeter  to  be   printed  at  the  'end'  of  the  line
'''
