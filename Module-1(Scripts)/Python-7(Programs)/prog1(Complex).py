...
'''
try:
	a = complex(input('Enter first complex number : ')) #  Reads  1st  complex  number  to  object  'a'
	b = complex(input('Enter second complex number: '))  #  Reads  1st  complex  number  to  object  'b'
	print('Sum : ' , a + b)
