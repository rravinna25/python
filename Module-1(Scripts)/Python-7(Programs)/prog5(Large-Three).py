...
3) What  is  the  output  if  inputs  are  'RAMA'  , 'RAJESH'  and  'RAKESH' ?   --->  'RAMA'
...
3) max =  a   if  a > b  >  c   else  b  if  b > c  else  c
    What  is  the  issue  with  chaining  ?  ---> Largest  number  is  not  obtained  when  inputs  are  30 , 10  and  20	
'''
