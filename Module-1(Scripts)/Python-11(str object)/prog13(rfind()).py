# rfind()  method  demo  progran (Home  work)
a = 'Hyd is green city. Hyd is hitec city. Hyd is his cityi'
index = a . rfind('is')  #    Index  of  first  'is'  in  object  'a'  from  the  end  of  object  'a'
while  index != -1:    #  Repeat  until  no  more  'is'
	print(index)  #  Index  of   each  'is'   from  the   end  of  object  'a'  i.e.  46  , 42  , 23  ,  4
	index = a . rfind('is' , 0 , index)   #    Index  of   next   'is'  in  object  'a'  from  index  -  1  downto  0
print('End')
