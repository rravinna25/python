...
4) [eval(x)   for  x  in   input('Enter  any  3  inputs  separated  by  comma : ') . split(',')]
    What  is  the  advantage  of  the  statement ?   --->  Single  statement  reads  multiple  inputs
    What  is  the  dis-advantage  of  the  statement ?  --->  Too  much  of  processing  and  difficult  to  understand

5) a , b , c = [eval(x)   for   x   in   input('Enter  any  3   inputs  separated  by  space  :   ') . split()]
    How  to  divide  the  statement  into  three  statements  ?  --->  a = eval(input())
														  				                                  b = eval(input())
																		                                  c = eval(input())
...
6) a = eval(input())
    b = eval(input())
    c = eval(input())
    What  is  the  advantage  of  the  three  statements ?   ---> Easy  to  understand
    What  is  the  dis-advantage  of  the  three  statements ?  ---> Too  many  statements

7) [eval(x)   for  x  in   input('Enter  any  3  inputs  separated  by  comma : ') . split(',')]
    What  is  the  statement  called ?  ---> List  comprehension
'''
