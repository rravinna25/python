...
a  = 10 , 20 , 30 , 40 , 50
#    0     1      2     3     4
#a . insert(3 , 35)  # Error : No  insert()  method  in  tuple
print(a , id(a))  #  (10 , 20 , 30 , 40 , 50)  <space>  Address of  5-element  tuple (may  be  1000)
a = a[ : 3] + (35,) + a[3:]  #  Modifies  ref  'a'  to  a  new   tuple  of  6  elements  i.e.  a = (10 , 20 , 30) + (35,) + (40 , 50)  =  (10 , 20 , 30 , 35 , 40 , 50)
print(a , id(a))  #  (10 , 20 , 30 , 35 , 40 , 50)  <space>  Address  of  6-element  tuple (may  be  2000)
