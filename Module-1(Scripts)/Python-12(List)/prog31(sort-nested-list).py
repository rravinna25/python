...
'''
1) What  does  sorted(nested-list)  do ?  --->  Sorts  outer  list  based  on  the  first  element  of  each  inner  list

2) How  to  sort  on  2nd  element  of  each  inner  list ?  --->  With  key  argument  of  sorted()  function  and  lambda  function
'''
