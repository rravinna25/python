...
'''
a = input('Enter 1st string : ')  #  Reads  1st  string
b = input('Enter 2nd string : ') #  Reads  2nd   string
c = [x + y   for   x   in   a     for   y   in   b]  #  Appends  x + y  to  list  'c'  where  'x'  is  each  char  of  1st  string and  'y'  is  each  char  of  2nd  string
print(c)
