...
list . insert(-len(list) , 12) #  Insert  12  at  the  begining  of  list    i.e.  After  index  -length
print(list)  #   [12 , 10 , 20 , 25 , 15 , 18]
list . insert(-10 , 19)  #   Inserts  19  at  the  begining  of   the   list  as  -10  is  invalid  index
print(list)   #   [19 , 12 , 10 , 20 , 25 , 15 , 18]
# How  to  insert   100  at  the  end  of  list  with  -ve  index  --->  Not  possible
