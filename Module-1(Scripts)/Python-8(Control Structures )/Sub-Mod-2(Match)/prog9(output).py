...
match  tpl:
	case  (0 , 0):  #  Executed  when  tpl  is  (0,0)
		print('Origin')
	case   (0 , y):  #  Executed  when  tpl  is  (0,Non-zero)
		print('y - axis')
	case   (x , 0):  #  Executed  when  tpl  is  (Non-zero , 0))
		print('x - axis')
	case   (x , y):  #  Executed  when  tpl  is  (Non-zero,Non-zero)
		print('Quadrant')
	case  _:   #  Executed  when  tpl  is  none  of  the  above
		print('Not  a  point')
