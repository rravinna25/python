...
Infinite  Loop
-----------------
1) What  is  infinite  loop ?  --->  When  while  loop  condition  is  always  true,  it  is  called  infinite
...
5) Finally, ensure  that  while  loop  condition  becomes  false,  at  least  after  few  iterations
     (if  not  immediately)
'''
