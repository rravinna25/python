...
#f1(a = 1 , 2 , c = 3) # Error :  PA   2  is  not  permitted  after  KA  a = 1
#f1(1 , 2 , 3) # Error :   'a'  is  1 , 'b'  is  (2 , 3)  but  argument  is  not  passed  for  'c' 
#f1(a = 1 , b = 2 , c = 3) # Error :  Var-arg  parameter  can  not  be  a  keyword  argument
#f1(a = 25 , 100 , 200 , 300 , c = 35) # Error  :   PA  100  is  not  permitted  after  KA  a = 25
...
3) Can  'a'  be  a  keyword  argument ?  --->  No  becoz  it  precedes  var-arg  parameter

4) Is  f1(KA , PA , KA)  valid ?  --->  No  becoz  Positional  argument  can  not  be  after  keyword  argument

5) f1(10 , 20 , 30 ,  40)
    What  is  the  issue  with  the  function  call ?  --->  No  becoz  'a'  is  10 , b  is  (20 , 30 , 40)  and
