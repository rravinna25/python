...
# End  of  the  function
disp(25 , 'Rama Rao' , 10000.0) # Emp  Number :  <2  spaces>25   <tab>  Emp  Name : Rama Rao <7  spaces>  <tab>  Salary : 10000.0
disp(ename = 'Sita' , sal = 20000.0 , empno = 35) # Emp  Number :  <2  spaces>35   <tab>  Emp  Name : Sita  <11  spaces>  <tab>  Salary : 20000.0
x = 'Rama  Rao'
y = 30000.0
z = 20
disp(x , y , z) # Emp  Number :   Rama Rao  <tab>  Emp  Name :  <8  spaces> 30000.0  <tab> Salary :  20
