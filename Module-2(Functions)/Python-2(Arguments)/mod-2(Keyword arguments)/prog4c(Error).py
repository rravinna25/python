...
def  f4(* , a , b , c , /):   #   Error :  Confusion  about  how  to  treat  a ,  b , c  as  PA's  (or) KA's
	        pass
...
4) def  f4(* , a , b , c , /):
	        pass
    What  can  be  passed  to  function  f4() ?  --->  Ambiguity  error :  How  to  treat  a , b ,  c ( PA's  (or)  KA's)
'''
