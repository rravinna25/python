...
__defaults__
-----------------
1) What  is    __defaults__  ?  --->  A  tuple  with  all  the  default  values  of  function  arguments 

2) What  is  the  syntax  of  __defaults__ ?  ---> functionname . __defaults__

3) What  is   f1 . __defaults__ ?  --->  A  tuple  with  all  the  default  values  of  arguments  of  f1  function

4) Who  is  initializing   __defaults__ ?  ---> PVM

5) When  is   __defaults__  initialized ?  --->  As  soon  as  function  is  defined

6) What  is  the  value  of  __defaults__ without  default  arguments ?  --->  None  but  not  empty  tuple

7) If  a  function  modifies   values  of   default  arguments,  __defaults__  is  automatically  modified  by  pvm
'''
