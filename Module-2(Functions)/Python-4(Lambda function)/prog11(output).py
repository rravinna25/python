...
key = 'power_3'
print(a[key]) #  print(a['power_3'])  --->  print(lambda  x : x ** 3)  ---> Type and address of lamba function
print(a[key](5)) #  print(a['power_3'](5))  --->  print((lambda  x : x ** 3)(5))   --->  'x'  is  5  and  result  is  5 ** 3 = 125
