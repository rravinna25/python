...
def  power(a , b):
	if  b > 0:
		return  a * power(a , b - 1)  #  Continue  recursion  as  long  as   b  is  +ve  positive  power
	if  b < 0:
		return  1 / a * power(a , b + 1)  #  Continue  recursion  as  long  as   b  is  -ve  positive  power
	return  1  #  Suspend  recursion  as  soon  as  power  is  0
'''
...
print(F'{a} ^ {b} = {power(a , b)}')  #  prints  a , b  and  a ^ b
