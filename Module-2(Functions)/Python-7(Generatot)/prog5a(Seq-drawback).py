...
list = [x * x   for   x   in   range(500000000)]  #   Stores  500000000  elements  in  a  list
for  y  in  list:   #   Iterates  list  after  500000000  elements  are  stored  in  the  list  which  may  not  happen  immediately
	print(y)
...
1) What  are  the  two  drawbacks  of  seqeunces ?  --->
	...
	b) Memory  Error:  When  there  are  too  many  elements,  there  may  not  be  enough  memory  to  represent  all
	                                of  them  in  sequence
